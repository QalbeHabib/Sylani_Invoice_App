        ...
        <div className="basis-[80%] mt-10 lg:basis-1/2">
          <div className="flex flex-row justify-between mb-8">
            ...
            <div className="flex flex-row ">
              ...
              <div
                onClick={() => addInvoice()}
                className=" cursor-pointer flex justify-center items-center px-4 py-1 border border-transparent shadow-sm text-sm font-bold rounded-full text-white bg-[#7c5dfa] hover:bg-[#5c3be2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500	"
              >
                <span className="  bg-white rounded-[14%] md:rounded-full flex justify-center items-center  w-5 h-5 mr-2 text-gray-600 font-bold ">
                  +
                </span>
          ...
          {status.map((value, index) => (
            <div
              ...
              className=" hidden  w-full bg-[#1f213a] p-5 rounded-md md:flex md:flex-row justify-between items-center mb-2.5 cursor-pointer  border border-transparent transition hover:border-[#fff] hover:scale-105 duration-300 ease-in-out"
            >
