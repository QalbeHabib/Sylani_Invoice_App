              ...
              <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full ">
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-2xl">
                    <div className="flex h-full flex-col overflow-y-scroll bg-[#141625] shadow-xl no-scrollbar p-5">
                      <div className="">
                        ...
                        <div className="mt-10 sm:mt-0">
                          <div className="mt-5 md:mt-0 md:col-span-2">
                            ...
                            <div className="shadow-lg border mt-5 overflow-hidden sm:rounded-md">
                              <div className=" px-4 py-5 bg-[#141625] sm:p-6">
                                <p className=" text-indigo-800 text-xl mb-5">
                                  Bill From
                                </p>
                                <Formik
                                  // validation
                                            ...
                                            <FieldArray name="items">
                                              {({ insert, remove, push }) => (
                                                <div>
                                                  ...
                                                  <button
                                                    type="button"
                                                    className=" bg-slate-700 w-full mt-7 text-center p-3.5 rounded-full text-white cursor-pointer mb-10"
                                                    onClick={() =>
                                                      push({
                                                        itemName: "",
                                                        qty: "",
