    ...
    <>
      <div className="flex flex-row bg-[#141625] ">
        ...
        <div className="basis-[70%] mt-10 lg:basis-1/2">
          <p
            className="text-white p-3 cursor-pointer hover:text-[#7c5dfa] transition"
            onClick={() => goback()}
          >
            Go Back
          </p>
          <div className=" w-full flex flex-col  md:flex-row justify-between mb-8 bg-[#1e2139] p-5 rounded-md">
            <div className="flex flex-row m-1.5">
              <span className="text-white pt-3 ">Status</span>
              <p className="bg-green-300/[.06] h-10 w-max rounded-md p-2 px-4 text-[#58cfb6] m-1.5 ml-2">
                ● {data.invoice_status}
              </p>
            </div>
            <div className="w-full flex md:flex justify-end">
              <div
                onClick={() => editInvoice()}
                className="w-[100px] inline-flex justify-center py-4 px-8 border border-transparent shadow-sm text-sm font-medium rounded-full text-white bg-[#3f3f3f] hover:bg-[#272626] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mx-2"
              >
                Edit
              </div>
              <div
                onClick={() => deleteInvoice()}
                className="w-[100px] inline-flex justify-center py-4 px-8 border border-transparent shadow-sm text-sm font-medium rounded-full text-white bg-[#ec5757] hover:bg-[#e64141] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Delete
              </div>
              {data.invoice_status == "Paid" ? null : (
                <div
                  onClick={() => setPaid()}
                  className="w-[100px] inline-flex justify-center py-4 px-2 border border-transparent shadow-sm text-sm font-medium rounded-full text-white bg-[#7c5dfa] hover:bg-[#5c3be2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mx-2"
                >
                  Mark as Paid
                </div>
              )}
          ...
          <div className="mb-8 bg-[#1e2139] p-5 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cold-3 place-content-center space-y-5 md:space-y-0   md:space-x-5 bg-[#1e2139] p-5 rounded-md">
              <div className="  text-[12px] ">
                ...
                <br />
                <br />
                <p className="text-white">Payment Due</p>
                <p className="text-white text-xl font-bold">
                  {data.bill_to_client_invoice_date
                    ? data.bill_to_client_invoice_date.split("T")[0]
                    : null}
            ...
            <div className="bg-[#252945] p-5 rounded-md">
              <div className=" w-full h-10 text-[12px] flex flex-row justify-between">
                ...
                <div className="flex flex-row">
                  <p className="text-white mt-3">QTY.</p>
                  <p className="text-white mt-3 px-8">Price</p>
                  <p className="text-white mt-3 ml-8  text-right">Total</p>
                </div>
              </div>
            ...
            <div className="bg-[#000000] flex flex-row mb-8 p-5 rounded-md">
              <div className=" w-full h-16 text-[12px] flex flex-row justify-between">
                <p className="text-white mt-3  text-xl">Account Due</p>
                <div className="flex flex-row">
                  <p className="text-white mt-3"></p>
                  <p className="text-white mt-3 px-8"></p>
                  <p className="text-white mt-3 ml-8  text-right text-2xl">
                    £{sum}
                  </p>
                </div>
              </div>
