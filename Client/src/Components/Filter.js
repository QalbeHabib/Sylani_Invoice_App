...
export default function Filter() {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-40 rounded-md z-10 shadow-lg bg-[#252945] ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
